...
function createFixtures() {
  ...
  fs.writeFileSync(path.join(engineerDir, 'SOUL.md'), `# SOUL.md - Test Engineer
...
`);
  ...
  fs.writeFileSync(path.join(reviewerDir, 'SOUL.md'), `# SOUL.md - Code Reviewer
...
`);
  ...
  fs.writeFileSync(path.join(githubSkillDir, 'SKILL.md'), `# GitHub Integration
...
`);
  ...
  fs.writeFileSync(path.join(deploySkillDir, 'SKILL.md'), `# Deploy
